...
figure(110); stem(G_HS_Pulse); title('Impulse Response Half-Sine Matched Filter')
figure(111); stem(G_SRRC_Pulse); title('Impulse Response SRRC Matched Filter')
%Plot frequency responses of Matche Filters
figure(112); freqz(G_HS_Pulse); title('Frequency Response of Half-Sine Matched Filter')
figure(113); freqz(G_SRRC_Pulse); title('Frequency Response of SRRC Matched Filter')
