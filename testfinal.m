...
figure(3); plot(sPulse); title('Half-Sine Pulse');                     %Plots single Half-sine pulse
figure(4); freqz(sPulse); title('Frequency Response of Half-Sine Pulse')
figure(5); plot(SRRCPulse); title('Square-Root Raised-Cosine Pulse')                  %Plots single SRRC pulse                      
figure(6); freqz(SRRCPulse); title('Frequency Response of SRRC Pulse')
figure(7); plot(modBsSP); title('Modulated Half-Sine Pulse')                    %Modulated signal with HS pulse
figure(8); freqz(modBsSP); title('Frequency Response of Modulated HS Pulse')
figure(9); plot(modStreamSRRC); title('Modulated SRRC Pulse')              %Modulated Signal with SRRC pulse
figure(10); freqz(modStreamSRRC); title('Frequency Response of SRRC Pulse')

%eye diagrams for the output of the modulator
eyediagram(modBsSP, 32 , 1, 16); title('Eye Diagram of Modulated Half-Sine Pulse')
eyediagram(modStreamSRRC, 32, 1); title('Eye Diagram of Modulated SRRC Pulse')
